...
const EarningCard = ({ isLoading }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('http://192.168.1.26/temperature');
                    ...
                    <Grid container direction="column">
                        ...
                        <Grid item>
                            <Grid container alignItems="center">
                                <Grid item>
                                    <Typography className={classes.cardHeading}>{earning}</Typography>
                                </Grid>
                                <Grid item>
                        ...
                        <Grid item sx={{ mb: 1.25 }}>
                            <Typography className={classes.subHeading}>Temperatura Biodigestor</Typography>
                        </Grid>
                    </Grid>
                </MainCard>
            )}
